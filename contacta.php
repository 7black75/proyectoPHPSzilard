<?PHP
	...
	$rutaInclude     = 		$jsonPropiedades['contactaInclude'];
	set_include_path 		($rutaInclude);

	// --------------------------------------------------------------- //
	// Acción ejecutada por el botón Enviar del formulario de contacto //
	// --------------------------------------------------------------- //
...
<html lang = "es">
	<head>
		<meta charset = "utf-8">
		<title> Contacta - El Ejército Negro </title>
		...
		<link rel='stylesheet' href = "css/contacta.css" type = "text/css">
	</head>
	<body>
		<?PHP
			// --------------------------------------------------------- //
