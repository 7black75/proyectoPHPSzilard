<?PHP
// Versión del index.php para usuarios Administradores.
print '
			<nav id = "naveg">
				<ul>
		...
		<section id = "contenedor">
			...
			<!-- Sección que permite al visitante suscribirse introduciendo su correo en la base de datos (tabla \'suscribir\') -->
