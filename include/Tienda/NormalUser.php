...
print '
		...
		<section id = "contenedor">
			...
			<article id = "criterio">
				...
				</select> <input id = "campoCriterio" type = "text" name = "busqueda" placeholder = "Palabras a buscar" onfocus = "this.placeholder = \'\'" onblur = "this.placeholder = \'Palabras a buscar\'"> <br><br> <input id = "botonCriterio" type = "submit" name = "buscar" value = "Buscar"><br><span id = "user"> <a id = "anclaTienda"></a>* Por defecto se muestran todos los libros de forma paginada</span> </form>
			</article>
';
